...
public class ConfigManager {
    ...
    public static void saveState() {
        if (!loaded || !enabled) {
            FCRMain.log(Level.INFO, "Not saving config because we didn't load it yet");
            return;
        }
        FCRMain.log(Level.INFO, "Saving state");
        ...
        try {
            ...
            e.printStackTrace();
            FCRMain.log(Level.ERROR, "Failed to save config!");
        }
