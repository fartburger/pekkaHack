...
public class RangeSetting extends SettingBase<RangeSetting.Range> {
    ...
    public static class Builder extends SettingBase.Builder<com.fartburger.fartcheat.config.RangeSetting.Builder, Range, RangeSetting> {
        ...
        public com.fartburger.fartcheat.config.RangeSetting.Builder precision(int precision) {
            this.precision = precision;
            return this;
        }

        public com.fartburger.fartcheat.config.RangeSetting.Builder lowerMin(double min) {
            this.min = min;
            return this;
        }

        public com.fartburger.fartcheat.config.RangeSetting.Builder lowerMax(double max) {
            this.max = max;
            return this;
        }
