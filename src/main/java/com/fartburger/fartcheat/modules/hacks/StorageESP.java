...
public class StorageESP extends Module {
    ...
    @Override
    public void tick() {
        positions.removeIf(blockPos -> !(client.world.getBlockState(blockPos).getBlock() instanceof ChestBlock||client.world.getBlockState(blockPos).getBlock() instanceof ShulkerBoxBlock));
    }
