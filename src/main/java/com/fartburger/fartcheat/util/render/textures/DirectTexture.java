...
public class DirectTexture implements Texture {
    ...
    com.fartburger.fartcheat.util.render.Texture spriteId;

    public DirectTexture(String url) {
        this.url = url;
        this.spriteId = new com.fartburger.fartcheat.util.render.Texture("texture/remote/" + RandomStringUtils.randomAlphanumeric(16));
    }
